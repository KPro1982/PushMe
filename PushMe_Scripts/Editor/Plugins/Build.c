...
[WorkbenchPluginAttribute("Create UI from layout", "Creates UI scripts from layout file", "", "", {"ResourceManager", "ScriptEditor"})]
class CreateUIFromLayout: DayZProjectManager
{
	override void Run()
	{
		RunDayZBat(string.Format("P:\\%1\\Workbench\\Batchfiles\\CreateUIfromlayout.bat", ModName), true);
